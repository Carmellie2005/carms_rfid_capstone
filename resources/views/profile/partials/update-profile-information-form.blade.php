        ...
        <div class="grid gap-3 md:grid-cols-2">
            ...
            <div>
                ...
                <x-text-input
                    ...
                    name="username"
                    type="text"
                    class="mt-1 block w-full font-mono {{ $isGuard ? 'cursor-not-allowed bg-slate-50 text-slate-500 dark:bg-slate-800 dark:text-slate-300' : '' }}"
                    :value="$isGuard ? $user->username : old('username', $user->username)"
                    placeholder="{{ __('Username or Email') }}"
                    required
                    autocomplete="username"
                    inputmode="email"
                    :readonly="$isGuard"
                    :aria-readonly="$isGuard ? 'true' : 'false'"
                />
            ...
            <div>
                ...
                <x-text-input
                    ...
                    name="email"
                    type="email"
                    class="mt-1 block w-full {{ $isGuard ? 'cursor-not-allowed bg-slate-50 text-slate-500 dark:bg-slate-800 dark:text-slate-300' : '' }}"
                    :value="$isGuard ? $user->email : old('email', $user->email)"
